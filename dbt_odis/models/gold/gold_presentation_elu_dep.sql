...
with renommage_et_ajout_nuance as (
    ...
    select
        presentation_elus_communes.dep_code as "CODGEO",
        presentation_elus_communes.dep_name as "LIBGEO",
    ...
    where type_de_la_fonction = 'Départemental'
    and libelle_de_la_fonction = 'Président du conseil départemental'
)
