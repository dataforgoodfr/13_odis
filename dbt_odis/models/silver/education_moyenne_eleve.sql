...
select
    ...
    region_academique,
    rentree_scolaire,
    cast(NULLIF(split_part(nombre_total_eleves::text, '.', 1), '') as integer) as nombre_total_eleves,
    cast(NULLIF(split_part(nombre_total_classes::text, '.', 1), '') as integer) as nombre_total_classes,
    cast(NULLIF(split_part(nombre_eleves_ulis::text, '.', 1), '') as integer) as nombre_eleves_ulis,
    cast(NULLIF(split_part(nombre_eleves_cp_hors_ulis::text, '.', 1), '') as integer) as nombre_eleves_cp_hors_ulis,
    cast(NULLIF(split_part(nombre_eleves_ce1_hors_ulis::text, '.', 1), '') as integer) as nombre_eleves_ce1_hors_ulis,
    cast(NULLIF(split_part(nombre_eleves_ce2_hors_ulis::text, '.', 1), '') as integer) as nombre_eleves_ce2_hors_ulis,
    cast(NULLIF(split_part(nombre_eleves_cm1_hors_ulis::text, '.', 1), '') as integer) as nombre_eleves_cm1_hors_ulis,
    cast(NULLIF(split_part(nombre_eleves_cm2_hors_ulis::text, '.', 1), '') as integer) as nombre_eleves_cm2_hors_ulis,
    cast(NULLIF(split_part(nombre_eleves_elementaire_hors_ulis::text, '.', 1), '') as integer) as nombre_eleves_elementaire_hors_ulis,
    cast(NULLIF(split_part(nombre_eleves_preelementaire_hors_ulis::text, '.', 1), '') as integer) as nombre_eleves_preelementaire_hors_ulis,
    created_at
from unioned